...
var poissP = function (lambda, T, path) {
  var U, exp, N_t, t, n;
  N_t = [0];
  t = 0;
  n = 0;
...
var GBM = function(S0, mu, sigma, T, steps, path) {
  var S_t = [];
...
var DTMC = function(transMatrix, steps, start, path) {
...
var CTMC = function(transMatrix, T, start, path) {
